package com.throne.managers
{
	import com.throne.gui.interfaces.ILayer;
	import com.throne.gui.layers.BaseLayer;
	...
	public class ViewManager
	{
		...
		public function ViewManager(pvt : SingletonEnforcer = null)
		{
			if (pvt == null) 
			{ 
				throw new Error("Please use ViewManager.getInstance()");
			}
		}
		...
		{
			return _layers.getValue(_name) as ILayer;
		}
