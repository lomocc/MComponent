package app.components
{
	...
	import app.events.ClickCountEvent;
	import app.events.DragAndDropEvent;
	import app.utils.DisplayUtil;
	import app.utils.IntPoint;
	import app.utils.SourceData;
	...
	[Event(name="clickCount", type="app.events.ClickCountEvent")]
	
	
	[Event(name="dragRecognized", type="app.events.DragAndDropEvent")]
	
	
	[Event(name="dragEnter", type="app.events.DragAndDropEvent")]
	
	
	[Event(name="dragExit", type="app.events.DragAndDropEvent")]
	
	
	[Event(name="dragDrop", type="app.events.DragAndDropEvent")]
	
	
	[Event(name="dragOverring", type="app.events.DragAndDropEvent")]
