package app.components
{
	...
	[Event(name="release", type="app.events.ReleaseEvent")]
	[Event(name="releaseOutSide", type="app.events.ReleaseEvent")]
	public class TSprite extends Sprite implements IDisposable
	{
		...
		public function set checkClickOutSide(value:Boolean):void
		{
			...
			if(value)
				DisplayUtil.getStage().addEventListener(MouseEvent.MOUSE_DOWN, __stageMouseDownListener);
			else
				DisplayUtil.getStage().removeEventListener(MouseEvent.MOUSE_DOWN, __stageMouseDownListener);
		...
		private function __stageMouseDownListener(e:MouseEvent):void{
			...
			DisplayUtil.getStage().addEventListener(MouseEvent.MOUSE_UP, __stageMouseUpListener, false, 0, true);
		...
		private function __stageRemovedFrom(e:Event):void{
			pressedTarget = null;
			DisplayUtil.getStage().removeEventListener(MouseEvent.MOUSE_UP, __stageMouseUpListener);
		}
		...
		{
			DisplayUtil.removeFromContainer(this);
		}
